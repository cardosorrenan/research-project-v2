...
2. Installing the myBTD Package

A. Change to the directory that contains the file setup.py and the subdirectory myBTD. If 
...
3. Using the myBTD Package

The myBTD package is on your Python path. To import it into a Python script or session, 
execute:
